...
:PROPERTIES:
:CUSTOM_ID: Master Foo and the Ten Thousand Lines
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Script-Kiddie
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-Discourses-on-the-Two-Paths
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Methodologist
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-Discourses-on-the-Graphical-User-Interface
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Old-Hand
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Shell-Tools
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Nervous-Novice
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Recruiter
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-Discourses-on-Returning-to-Windows
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Unix-Zealot
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-Discourses-on-the-Unix-Nature
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-MCSE
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-End-User
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Programming-Prodigy
:END:
...
:PROPERTIES:
:CUSTOM_ID: Master-Foo-and-the-Hardware-Designer
:END:
