...
1.  [Rootless Root](#rootless-root)
    1.  [Editor&rsquo;s Introduction](#editors-introduction)
    2.  [Master Foo and the Ten Thousand Lines](#org1035b88)
    3.  [Master Foo and the Script Kiddie](#org16edc80)
    4.  [Master Foo Discourses on the Two Paths](#org008e477)
    5.  [Master Foo and the Methodologist](#org6065b6c)
    6.  [Master Foo Discourses on the Graphical User Interface](#orgd7761fa)
    7.  [Master Foo and the Old Hand](#org8f9b86b)
    8.  [Master Foo and the Shell Tools](#org979c509)
    9.  [Master Foo and the Nervous Novice](#orge612ddc)
    10. [Master Foo and the Recruiter](#org1e02a08)
    11. [Master Foo Discourses on Returning to Windows](#orgd999150)
    12. [Master Foo and the Unix Zealot](#org87d75bb)
    13. [Master Foo Discourses on the Unix-Nature](#org80f65df)
    14. [Master Foo and the MCSE](#orgcbde444)
    15. [Master Foo and the End User](#orgbea2199)
    16. [Master Foo and the Programming Prodigy](#orgb02de1d)
    17. [Master Foo and the Hardware Designer](#orge5e19b3)
